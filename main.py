...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../LTLE/FB15K/FB15k237-Fed3.pkl', type=str)
    parser.add_argument('--name', default='fb15k237_fed3_fed', type=str)
    ...
    parser.add_argument('--model', default='RotatE', choices=['TransE', 'RotatE', 'DistMult', 'ComplEx'])
